...
module.exports = {
	...
	//distribution version for live/production environment
	dist: {
		options: {
		...
		files: {
			'<%= package.basedir %>/assets/dist/css/main.min.css': [
				'<%= package.basedir %>/assets/src/sass/app.scss'
			],
			'<%= package.basedir %>/assets/dist/css/ie8.css': [
				'<%= package.basedir %>/assets/src/sass/ie8.scss'
			],
			'<%= package.basedir %>/assets/dist/css/editor-style.css': [
				'<%= package.basedir %>/assets/src/sass/editor/editor-style.scss'
			]
		}
	},
